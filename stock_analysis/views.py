...
# GOOGLE_API_KEY = 'AIzaSyDgzB1e7WfmvUBA-GcJjyWQBtfS2A4N7ok' 
# try:
...
#                 {{
#                     "price_summary": "Brief analysis of price performance",
#                     "news_summary": "Analysis of recent news sentiment",
...
#                 response = model.generate_content(prompt, max_tokens = 2048)  # Add timeout
#                 try:
#                     analysis = json.loads(response.text)
#                 except json.JSONDecodeError:
#                     # Fallback if JSON parsing fails
#                     analysis = {
#                         "price_summary": response.text[:200] + "...",
#                         "news_summary": "Unable to parse full analysis",
...
#             'price_data': None,
#             'news_data': None
#         }, status=500)from django.shortcuts import render
